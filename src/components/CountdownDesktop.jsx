...
export default function CountdownDesktop({ setIsReleased }) {
  return (
    <div 
    ...
    >
      <div className="relative backdrop-blur-2xl bg-slate-950/50 p-12 rounded-[2.5rem] border border-white/10 shadow-2xl text-center max-w-2xl w-full mx-4 overflow-hidden">
        
        <h1 className="text-6xl font-black tracking-tighter text-white drop-shadow-lg uppercase">
          liontech
        </h1>
        ...
        <div className="flex justify-center items-center gap-10 mb-12">
          {/* Tus enlaces de redes sociales de PC idénticos */}
          <a href="https://www.instagram.com/liontech_accesorios?igsh=OXd2a2trNTE1bzE=" target="_blank" rel="noreferrer" className="group flex flex-col items-center gap-2">
            <div className="p-3 bg-white/5 rounded-2xl border border-white/10 group-hover:bg-pink-600/20 group-hover:border-pink-500/50 transition-all duration-300">
              <svg className="w-5 h-5 text-white/40 group-hover:text-pink-500 transition-colors" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path></svg>
            </div>
          </a>
          <a href="https://www.facebook.com/profile.php?id=61568382338538" target="_blank" rel="noreferrer" className="group flex flex-col items-center gap-2">
            <div className="p-3 bg-white/5 rounded-2xl border border-white/10 group-hover:bg-blue-600/20 group-hover:border-blue-500/50 transition-all duration-300">
              <svg className="w-5 h-5 text-white/40 group-hover:text-blue-500 transition-colors" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
            </div>
          </a>
        ...
        <div className="relative pt-8 border-t border-white/10">
          <span className="text-[10px] tracking-[0.4em] uppercase font-black text-cyan-400/60 block mb-2">Fecha de Lanzamiento</span>
